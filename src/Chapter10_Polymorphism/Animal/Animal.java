...
/*
 * This example is to showcase overriding to toString method which is inherited by the Object class.
 * Originally, the Object class prints out the name of the class followed by an @ and then the memory address, which is useless to us developers.
 * We can directly override this method to introduce some new logic which is printing our species, name and our age.
 * Now every time we pass an Animal object reference to a System.out.print invocation, it will call the overridden toString method.
 * Subsequently all inherited children will also have this happen since every child is an Animal, see the Zoo example for an example of this.
 */
...
public class Animal { // Class declaration
    ...
    public String toString(){
        return this.getName() + " is a " + this.getSpecies() + "." + " And, they are " + this.getAge() + " years old.";
    }
}